function realTimeLineChart() {
    ...
    function chart(selection) {
      ...
      selection.each(function(data) {
        ...
        // var svgHeight = d3.select("svg").node().getBoundingClientRect().height;
        // var rect1Height = svgHeight * 40 / 100;
        ...
        //     .append("rect")
        //     .attr("price", svgWidth - rect1Width)
        //     .attr("width", rect1Height)
        //     .attr("height", 100)
        //     .style("fill", "red")
        //     .attr("opacity", 0.2);
